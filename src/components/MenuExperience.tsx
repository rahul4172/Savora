...
const menuData: Dish[] = [
  ...
  { id: '3', category: 'Appetizers', name: 'Herb Crusted Lamb Chops', description: 'Australian lamb cutlets with rosemary crust, served with roasted vegetables.', price: 1350, image: '/images/dish_wagyu.png', isVeg: false, spiceLevel: 2, isChefRec: true, prepTime: '20 mins' },
  { id: '4', category: 'Appetizers', name: 'Crispy Lotus Stem', description: 'Crispy lotus stem with spicy sichuan glaze.', price: 750, image: '/images/truffle_scallops.png', isVeg: true, spiceLevel: 2, isChefRec: false, prepTime: '15 mins' },
